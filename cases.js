...
venom.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": nomebot,"body": `👋🏻 Olá ${nome}`, "previewType": "PHOTO","thumbnail": thumb,"sourceUrl": `https://chat.whatsapp.com/KHgbfpFvs811js5XfJ9DG0`}}}, { quoted: msg})}
...
thumbnail: thumb,
sourceUrl: "https://chat.whatsapp.com/KHgbfpFvs811js5XfJ9DG0",
mediaType: 1,
...
`FN:${nomedono}\n` + 
`ORG:${nomebot};\n` + 
`TEL;type=MSG;type=CELL;type=VOICE;waid=${numerodono}:+${numerodono}\n` + // WhatsApp ID + phone number
'END:VCARD'
			venom.sendMessage(from, {
contacts: {
